            ...
            if "State." in info:
                ...
                if "[" in keyitem[1]:
                    try:
                        ...
                        print("ERROR - - reading the line below")
                        print(keyitem[1])
                else:
...
if __name__ == "__main__":
    ...
    iminfo = FileReader()
    file_path = r"\\RY-LAB-WS04\ImagingData\Tetsuya\20241231\24well\highmag_GFP200ms47p\tpem\A5_00_2_1__highmag_1_002.flim"
    iminfo.read_imageFile(file_path, True)     
    six_dim = np.array(iminfo.image)
    print(np.array(iminfo.image).shape)
    print(iminfo.State.Uncaging.PositionV)    
