...
if __name__ == "__main__":
    ...
    lowmag_path_list = [r"G:\ImagingData\Tetsuya\20240626\multipos_2\a_001.flim",
                        r"G:\ImagingData\Tetsuya\20240626\multipos_2\b_001.flim"]
    ...
    for nth_acq in range(50):
        ...
        for Each_lowmag_instance in lowmag_instance_list:    
            ...
            FLIMageCont.set_param(RepeatNum = 1, interval_sec = 500, ch_1or2 = 2)
