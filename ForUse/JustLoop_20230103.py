...
FLIMageCont.set_param(RepeatNum=80, interval_sec=10, ch_1or2=2,
                      LoadSetting=False,drift_control=False,
                      ShowUncagingDetection=True,drift_cont_galvo=False,expected_grab_duration_sec=4)       
