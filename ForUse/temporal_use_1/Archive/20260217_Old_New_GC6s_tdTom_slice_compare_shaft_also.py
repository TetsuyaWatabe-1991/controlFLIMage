...
limit_max_aligned_time_sec = 3000
LTP_data_point_after_min_between = [25,35]

acquisiton_start_datetime_str = "2026-02-17T17:20:00.000"
...
for each_header, each_header_name in group_header_dict.items():
    ...
    for each_uncaging_power_coherent_mW in fulltimeseries_df["uncaging_power_coherent_mW"].unique():
        ...
        plot_df = each_group_same_unc_pow_df[each_group_same_unc_pow_df["aligned_time_sec"] < limit_max_aligned_time_sec]
