...
filelist = glob.glob(r"Z:\Yasuda_lab\Users\WatabeT\20250424\HACSF_titration_*.flim")

grouped_files = defaultdict(list)

pattern = re.compile(r'HACSF_titration_(\d+um_\d+)_\d+\.flim')
...
for group, files in grouped_files.items():
    ...
    for each_file in files:
        ...
        pow_mw = 0.304 * uncaging_pow + 0.126
...
with open(r"Z:\Yasuda_lab\Users\WatabeT\20250424\plot\result.csv", "w") as file:
