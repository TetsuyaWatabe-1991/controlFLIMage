# -*- coding: utf-8 -*-
"""
Created on Tue Apr 29 14:38:17 2025
...
# "G:\ImagingData\Tetsuya\20250428\B6GC6sTom0331\titration_n1_d1_19um_001.flim"

filelist = glob.glob(r"G:\ImagingData\Tetsuya\20250425\B6GC6sTom0331\titration\HACSF_titration*.flim")
...
result_txt = ""
result_txt += "{group},{um},{pow_mw_round},{pre_mean_intensity}, {post_mean_intensity}, {dend_F_F0}, {pre_spine_intensity}, {post_spine_intensity}, {spine_F_F0}".replace("{","").replace("}","")   + "\n"
...
for group, files in grouped_files.items():
    ...
    for each_file in files:
        ...
        motorPosition = uncaging_iminfo.statedict["State.Motor.motorPosition"]
        z_um = motorPosition[-1]
        absolute_z_zero = 1285
        
        um = absolute_z_zero - z_um
        ...
        result_txt += f"{group},{um},{pow_mw_round},{pre_mean_intensity}, {post_mean_intensity}, {dend_F_F0}, {pre_spine_intensity}, {post_spine_intensity}, {spine_F_F0}"   + "\n"
...
print(res_save_path)
    ...
    # plt.title(f"Depth {depth} \u03BCm   \nUncaging with {pow_mw_round} mW for {pulseWidth} ms"
    #           , loc='left')  
    # plt.axis('off')
